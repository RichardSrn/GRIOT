...
class GritTransformerLayer(nn.Module):
    ...
    def __init__(self, in_dim, out_dim, num_heads,
        ...
        self.bn_momentum = 0.1  # cfg.bn_momentum
        self.bn_no_runner = False  # cfg.bn_no_runner
        ...
        if self.batch_norm:
            ...
            self.batch_norm1_h = nn.BatchNorm1d(out_dim, track_running_stats=not self.bn_no_runner, eps=1e-5, momentum=0.1)  # cfg.bn_momentum)
            self.batch_norm1_e = nn.BatchNorm1d(out_dim, track_running_stats=not self.bn_no_runner, eps=1e-5, momentum=0.1) if norm_e else nn.Identity()  # cfg.bn_momentum) if norm_e else nn.Identity()
        ...
        if self.batch_norm:
            self.batch_norm2_h = nn.BatchNorm1d(out_dim, track_running_stats=not self.bn_no_runner, eps=1e-5, momentum=0.1)  # cfg.bn_momentum)
